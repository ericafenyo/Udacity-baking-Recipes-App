...
@ContentProvider(authority = ShoppingListContentProvider.AUTHORITY, database = ShoppingListContract.ShoppingListDatabase.class)
public class ShoppingListContentProvider {
